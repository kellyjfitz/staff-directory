...
const HRLogin = ({navigation}) => {
  ...
  return (
      <View style={styles.screen}>
        ...
        <InputWithLabel label='First name' placeholder='Enter first name' onChangeText={setUserName} text={userName}
         />
        <InputWithLabel label='Password' placeholder='Enter password' onChangeText={setPassword} text={password}/>
